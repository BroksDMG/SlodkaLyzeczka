...
const CategorySiteContentSectionProductCardContainer = styled.div`
  ...
  cursor: pointer;
  h1 {
    color: ${(props) => props.theme.colors.textBlackShadow};
    text-align: center;
  }
  &:hover {
...
`;
const CategorySite: React.FC<CatergorySiteInterface> = ({
  categoryId,
  setCategoryId,
}) => {
  const productsSiteData =
    ProductsData[categoryId as keyof ProductDataInterface] || {};
  return (
      ...
      <Test>
        {setCategoryId && (
          <ExitButton
            ...
            $bgColor={productsSiteData.color}
          >
            <BiSolidRightArrow />
          </ExitButton>
        )}
        <CategorySiteHeaderSection $bgColor={productsSiteData.color}>
          <div>
            ...
            <MainImage
              src={productsSiteData?.categoryImage}
              width={1024}
              height={1024}
              alt="mainbirthdayimage"
            />
          </div>
          <CategorySiteDescSection $bgColor={productsSiteData.color}>
            <span>
              W tym miejscu znajdziesz inspiracje na wyjątkowe torty urodzinowe!{" "}
            </span>
            <p>
              Oferujemy szeroki wybór wzorów i smaków, które uczynią każdą
              uroczystość niezapomnianą.
              <br />
              Przejrzyj nasze przykładowe realizacje, a jeśli masz swój własny
              pomysł, chętnie zrealizujemy Twoje marzenie.
            </p>
            <p>
              Napisz do nas, a wspólnie stworzymy tort idealnie dopasowany do
              Twoich potrzeb!
            </p>
            <div>
              <a
                href="https://www.instagram.com/direct/t/105916064139736"
                target="_blank"
...
const ProductsData: ProductDataInterface = {
  ...
  OccasionalSweets: {
    categoryTitle: "Słodkości Okazjonalne",
    subTittle: "w tym miejscu znajdziesz torty",
    categorySiteDescription: "oferujemy fajne torty, zobacz niżej",
    buttonDesc: "Napisz do nas będzie fajnie",
  ...
  SeetTables: {
    categoryTitle: "Słodkie Stoły",
    subTittle: "w tym miejscu znajdziesz torty",
    categorySiteDescription: "oferujemy fajne torty, zobacz niżej",
    buttonDesc: "Napisz do nas będzie fajnie",
    color: theme.colors.beige,
    categoryImage:
      "/images/products/sweetTables/353072720_269987585561093_6036878025131667799_n.jpg",
    categoryGallery: [
      {
        img: "/images/products/weedingCakes/image 2.png",
        title: "Biała Róża",
